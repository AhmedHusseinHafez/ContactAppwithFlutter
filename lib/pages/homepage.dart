...
import 'package:contacts/dataBaseHandler/contatcsDataBaseHandler.dart';
import 'package:contacts/models/contactModel.dart';

import 'package:contacts/pages/settings.dart';
...
// Get Colors Themes, Backgrund, And Text
  //BackGroundColors
          ...
          return AlertDialog(
            ...
            content: Container(
              ...
              child: Column(
                children: [
                  Text(
                    (isUpdateMode) ? 'Update Contact' : 'Add Contacts',
                    textAlign: TextAlign.center,
